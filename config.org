  ...
  (setq
   ...
   `(("t" "✅ Todo")
     ...
     ("tP" "✈ POA"
      ...
      :kill-buffer t)
     ("tl" "💻 LTP"
      entry (file+headline "todo.org" "💻 LTP")
      "* TODO %?"
      :kill-buffer t)
     ("tm" "⁉ Misc."
...
+ Agenda overdue skip function taken from [[https://emacs.stackexchange.com/questions/75469/how-to-get-a-non-intersecting-overdue-next-7-days-agenda][Trevoke]] on stackexchage
#+begin_src emacs-lisp
(after! org-agenda
  ...
  (setq org-agenda-custom-commands
        '(("j" "Main agenda and todo list"
           ...
           ((agenda "" ((org-agenda-span 1)
            ...
            ;; all priority todos
            (tags-todo "+PRIORITY=\"A\""  ((org-agenda-overriding-header "✅ TODO - URGENT ✅")))
            (tags-todo "+PRIORITY=\"B\""  ((org-agenda-overriding-header "✅ TODO - IMPORTANT ✅")))
