...
(map! :leader
      ...
      (:prefix ("t" . "toggle")
       :desc "LSP Bridge"          "p"          #'lsp-bridge-mode
       :desc "Comapany Delay"          "P"      #'my/toggle-company-idle-delay
...
#+end_src
*** lsp-bridge
+ Not sure why we have to go through all oof this extra fuss to update some keybindings and faces but we do ([[https://github-com.translate.goog/manateelazycat/lsp-bridge/issues/516?_x_tr_sl=auto&_x_tr_tl=en&_x_tr_hl=en&_x_tr_pto=wapp][Source: Github]])
#+begin_src emacs-lisp
...
(with-eval-after-load 'lsp-bridge
  ...
  (evil-define-key 'insert acm-mode-map (kbd "C-S-j") #'acm-select-next-page)
  (evil-define-key 'insert acm-mode-map (kbd "C-S-k") #'acm-select-prev-page)
  (add-hook 'acm-mode-hook #'evil-normalize-keymaps )
  (add-hook 'acm-mode-hook
            (lambda ()
              (custom-set-faces!
                '(acm-frame-select-face :background "#272727"))))
  (setq lsp-bridge-enable-org-babel t
        lsp-bridge-org-babel-lang-list  nil))
(add-hook! ('typescript-mode-hook 'sh-mode-hook 'lua-mode-hook 'json-mode-hook 'conf-mode-hook) #'lsp-bridge-mode)
#+end_src
*** copilot
#+begin_src emacs-lisp
