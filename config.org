...
(use-package lsp-tailwindcss
  ...
  #+end_src
+ Match major modes to file extendions
  #+begin_src emacs-lisp
  ...
  (defun djs-org-agenda-files ()
    ...
    (setq org-agenda-files
          `("~/Sync/projects/org"
            ...
            ,(djs-get-most-recent-daily-node)
            )))
  ...
  (setq org-agenda-custom-commands
        '(("j" "Main agenda and todo list"
           ((agenda "" ((org-agenda-span 1)
            ...
            (tags-todo "+email" ((org-agenda-overriding-header "\n📧 Email\n--------")))
            (tags-todo "+daily" ((org-agenda-overriding-header "\n📅 Today\n--------")))
            (tags-todo "+main" ((org-agenda-overriding-header "\n✅ Todo\n--------")))
            (tags-todo "+literature" ((org-agenda-overriding-header "\n📚 Reading\n--------"))))))))

;; Hide noisy tag labels in agenda
(setq org-agenda-hide-tags-regexp "main\\|chore\\|hide\\|shopping\\|daily\\|calendars\\|email\\|daily\\|attach\\|literature")
#+end_src
...
(after! mu4e
  (setq mu4e-bookmarks
        '((:name "📧 All Mail"
           :query "maildir:/personal/Inbox OR maildir:/poa/Inbox OR maildir:/gmail/Inbox"
           :key 97)
          (:name "⁉ Unread Messages"
           :query "(maildir:/personal/Inbox OR maildir:/poa/Inbox OR maildir:/gmail/Inbox) AND flag:unread"
           :key 117)
          (:name "🔥 Spam"
           :query "maildir:/personal/\[Gmail\]/Spam OR maildir:/poa/\"Junk Email\" OR maildir:/gmail/\[Gmail\]/Spam"
           :key 115
           )
          (:name "🗑 Deleted Items"
          ...
          (:name "🚩 Flagged"
           ...
           :key 102)
          (:name "✈ Sent"
           :query "maildir:/personal/\[Gmail\]/\"Sent Mail\" OR maildir:/gmail/\[Gmail\]/\"Sent Mail\" OR maildir:/poa/\"Sent Items\""
           :hide-unread t
           :key 116))))
  #+end_src
