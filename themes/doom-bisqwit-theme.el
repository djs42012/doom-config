...
(def-doom-theme doom-bisqwit
  ...
  (((hl-line &override) :background base1)
   ...
   ((info-title-4 &override) :inherit 'variable-pitch :weight 'bold :foreground violet )
   ...
   ((magit-header-line &override) :foreground violet :background bg  :box `(:line-width -1 :color ,fg))
   ...
   ((markdown-header-face-1  &override) :foreground violet   :weight 'bold)
   ...
   ;; outline
   ((outline-1  &override) :foreground violet   :weight 'bold)
   ...
   ;; treemacs
   ((treemacs-root-face &override)  :foreground violet :weight 'bold )
   ...
   ((doom-themes-treemacs-root-face &override) :inherit 'font-lock-doc-face :foreground violet :weight 'bold )
