...
(def-doom-theme doom-bisqwit
                ...
                (((hl-line &override) :background base1)
                 ...
                 (org-modern-tag :inherit 'org-modern-label  :foreground green :background region :height 0.8)
                 (org-modern-bracket-line  :foreground bright-yellow :height 1.0)
                 (( org-modern-time-active &override) :inherit 'org-modern-label :foreground bright-yellow :background region :height 0.8)
                 (( org-modern-time-inactive &override) :inherit 'org-modern-label :foreground fg-alt :background region :height 0.8)
                 ((org-modern-date-active &override) :inherit 'org-modern-label :foreground bright-yellow :background region :height 0.8)
                 ((org-modern-date-inactive &override) :inherit 'org-modern-label :foreground fg-alt :background region :height 0.8)
