...
;;; Base theme face overrides
  (((hl-line &override) :background base0)
   ...
   ((company-tooltip-common &override) :foreground dark-cyan :weight 'bold)
   ...
   ((minibuffer-prompt &override) :foreground dark-cyan)
   (orderless-match-face-0 :foreground  dark-cyan :weight 'bold)
   (orderless-match-face-1 :foreground  green :weight 'bold)
   (orderless-match-face-2 :foreground  yellow :weight 'bold )
   (orderless-match-face-3 :foreground  dark-cyan :weight 'bold )
